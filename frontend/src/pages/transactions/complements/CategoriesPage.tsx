  ...
  if (!open) {
    return (
      <button
        ...
        className="app-add-dashed flex items-center gap-2 rounded-xl border-2 border-dashed border-slate-200 px-3 py-2.5 text-sm text-slate-400 transition hover:border-sky-300 hover:bg-sky-50/50 hover:text-sky-500"
      >
