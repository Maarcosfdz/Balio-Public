...
export default function DateRangePicker({
  ...
  const dayPickerClassNames = {
    ...
    range_middle: "tx-date-range-middle",
    today: "!text-sky-700 font-semibold",
  };

  const dayPickerRangeClassNames = {
    selected: "rounded-md",
    range_start: "!bg-sky-600 !text-white rounded-md",
    range_end: "!bg-sky-600 !text-white rounded-md",
    range_middle: "tx-date-range-middle",
  ...
  return (
    <div className="space-y-1">
      <label className="text-xs font-semibold text-slate-500">
        {label ?? t("txPage.selectDates", "Select date(s)")}
      </label>
        ...
        >
          ...
          <div className="mt-1 flex items-center justify-between border-t border-slate-100 pt-2">
            ...
            <button
              ...
              className="tx-date-action-btn tx-date-action-btn--ghost tx-date-action-btn--animated"
            >
