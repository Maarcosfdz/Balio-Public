-- ─────────────────────────────────────────────────────────────
-- V2 · Bank linking (Enable Banking), transaction bank metadata,
--      mapping rules, and analytics widgets
-- ─────────────────────────────────────────────────────────────
...
CREATE INDEX ix_bank_transaction_rules_user_account ON bank_transaction_rules(user_id, account_id);
